        ...
        <div class="container">
            <div class="row block-9">
                <div class="col-md-6 pr-md-5">
                    ...
                    <form method="post" action="{{ route('tinnhan.store') }}">
                        ...
                        <div class="form-group">
                            <input type="text" name="hoten" class="form-control px-3 py-3" placeholder="Tên bạn" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" name="tieude" class="form-control px-3 py-3" placeholder="Tiêu đề" required>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-6" id="map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3826.352407318903!2d107.58554931481298!3d16.457683988641968!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3141a147ba6bdbff%3A0x2e605afab4951ad9!2zVHLGsOG7nW5nIENhbyDEkeG6s25nIEPDtG5nIG5naGnhu4dwIEh14bq_!5e0!3m2!1svi!2s!4v1555986276905!5m2!1svi!2s" width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen=""></iframe>
                </div>
            </div>
        </div>
    </div>
